 ...
 * @FilePath: \iard:\0xFF JaeFrank\ForFun\SmartCar\SchoolGame\cyt4887_-free-rtos_-template\libraries\zf_device\zf_device_mpu6050.c
 * @Description:
...
#if MPU6050_USE_SOFT_IIC
    soft_iic_init(&mpu6050_iic_struct, MPU6050_DEV_ADDR, MPU6050_SOFT_IIC_DELAY, ZF_MPU6050_SCL_PIN, ZF_MPU6050_SDA_PIN);
#else
