...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     核心时钟设置
// 参数说明     clock       时钟频率 推荐使用 zf_common_clock.h 中
// system_clock_enum 定义的选项 返回参数     void 使用示例
// clock_set_freq(clock); 备注信息     本函数在文件内部调用 用户不用关注
// 也不可修改
//-------------------------------------------------------------------------------------------------------------------
...
// 参数说明     clock       时钟频率 推荐使用 zf_common_clock.h 中
// system_clock_enum 定义的选项 返回参数     void 使用示例
// clock_init(SYSTEM_CLOCK_250M);                  // 初始化核心时钟为 250MHz
