 ...
 * @FilePath: seekfree_assistant_interface.h
 * @Description:
...
typedef enum {
  ...
  SEEKFREE_ASSISTANT_CUSTOM,        // 自定义通讯方式
                             // 需要自行seekfree_assistant_transfer与seekfree_assistant_receive函数
} seekfree_assistant_transfer_device_enum;

#ifdef __cplusplus
extern "C" {
#endif // __cplusplus
void seekfree_assistant_interface_init(
    seekfree_assistant_transfer_device_enum transfer_device);
#ifdef __cplusplus
}
#endif // __cplusplus
