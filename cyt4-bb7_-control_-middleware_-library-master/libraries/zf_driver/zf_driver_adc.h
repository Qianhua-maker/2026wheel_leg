 ...
 * @FilePath: zf_driver_adc.h
 * JaeFrank\ForFun\SmartCar\SchoolGame\cyt4887_-free-rtos_-template\libraries\zf_driver\zf_driver_adc.h
 * @Description:
...
uint16 adc_mean_filter_convert(adc_channel_enum vadc_chn,
                               uint8 count); // ADC均值滤波
void adc_init(adc_channel_enum vadc_chn,
              adc_resolution_enum resolution); // ADC初始化
#ifdef __cplusplus
}
#endif // __cplusplus
//====================================================ADC
